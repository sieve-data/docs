    ...
    <ResponseField name="created_at" type="string">
      The time the job was created (ISO8601 format with milliseconds, e.g. 2023-10-05T22:45:34.238000).
    </ResponseField>
    <ResponseField name="started_at" type="string">
      The time the job started processing (ISO8601 format with milliseconds, e.g. 2023-10-05T22:45:34.238000).
    </ResponseField>
    <ResponseField name="completed_at" type="string">
      The time the job was completed (ISO8601 format with milliseconds, e.g. 2023-10-05T22:45:34.238000).
    </ResponseField>
