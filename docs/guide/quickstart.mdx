...
<video
  ...
  src="https://storage.googleapis.com/sieve-public-data/assets/docs/quickstart-example-video-trim.mp4"
></video>
      ...
      <Step title="Pushing a Sieve Job">
        ...
        curl -X POST \
          ...
          --data '{
            ...
            "inputs": {
              "file": {"url": "https://storage.googleapis.com/sieve-public-data/assets/docs/quickstart-example-video-trim.mp4"},
  ...
  <Tab title="Python">
    <Steps>
      ...
      <Step title="Pushing a Sieve Job">
        ...
        source_file = sieve.File(url="https://storage.googleapis.com/sieve-public-data/assets/docs/quickstart-example-video-trim.mp4")
