...
<Tabs>
  <Tab title="API">
    <Steps>
      ...
      <Step title="Monitoring Job Status">
        To fetch the job and its status, use the [get job](/reference-v2/api/get-job) endpoint.
      </Step>
    </Steps>
  ...
  <Tab title="Python">
    <Steps>
      ...
      <Step title="Monitoring Job Status">
        Navigate to your [Sieve Dashboard](https://www.sievedata.com/dashboard) and the job will appear there.
        ![first-job](https://storage.googleapis.com/sieve-public-data/assets/docs/dashboard-firstjob.jpg)
      </Step>
    </Steps>

    In production, you may choose to run jobs that are quite long, so you may want to use our async API.
...
<Steps>
  ...
  <Step title="Monitoring Job Status">
    You can see the status of your job in the playground. You can also navigate to your [Sieve Dashboard](https://www.sievedata.com/dashboard) and the job will appear there.
...
You can customize parameters and test more function-specific specs on [Dubbing API Page](https://www.sievedata.com/functions/sieve/dubbing/guide).
