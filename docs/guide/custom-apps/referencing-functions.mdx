...
description: "Call deployed functions from anywhere"
---
...
Running any public functions via API can be done through the [Push](/reference-v2/api/push) endpoint. Specific information for a public function can be found on the Usage Guide ([sample](https://www.sievedata.com/functions/sieve/autocrop/guide)).
