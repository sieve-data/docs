...
api: "POST https://api.sievedata.com/v1/push_image"
---
...
<Param body="image_url" type="string or list" required>
  Valid URL to video
</Param>

<Param body="image_name" type="string or list" required>
...
```json Example (List)
{
  ...
  "job_id": [
    "cb66397e-0284-4820-bdef-e9c071a39b37",
    "cb66397e-0284-4820-bdef-e9c071a39b38"
  ]
}
```
