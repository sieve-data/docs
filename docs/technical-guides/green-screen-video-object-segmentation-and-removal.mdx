...
description: "A overview and guide of useful AI models and how to deploy them to build video effects like Green Screen"
---
...
<Example>
  <div class="flex items-center justify-center">
    <iframe src="https://storage.googleapis.com/sieve-data-video-test-bucket/dancing.webm" className="w-full aspect-video rounded-lg shadow-lg"></iframe>
  </div>
</Example>
