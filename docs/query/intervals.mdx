...
api: "POST https://api.sievedata.com/v1/intervals"
---
...
<Param body="next_start" type="int">
  The amount of objects to skip in query (defaults to 0, used for paging)
</Param>

<Param body="YOUR_TAG" type="object | string">
  One of many tags in your schema. (you can specify as many of these as you
  want). These can be queried for in mongo format.
</Param>
