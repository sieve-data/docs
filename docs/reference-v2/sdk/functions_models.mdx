...
- `.run()` method blocks and waits for the function to complete, and directly returns the value returned by the function.
...
## Lifecycle of Functions and Models

[lots of specifics here that i kinda forget, need to go back to the code, I want to make a cool lil flowchart]
...
| gpu | bool | Determines whether the function is deployed on a server with a GPU | false |
...
| machine_type | str | Determines what type of gpu will be used (includes t4, a100, etc) | "t4" |
